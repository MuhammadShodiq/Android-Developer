package id.ac.poliban.mi.e020320050.notificationschedulercc_083;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Challenge Notification Scheduler Shodiq");
